package simit.org.jobbole.widget;
...
/**
 * Created by liuchun on 2016/4/7.
 */
public class RadioGroup extends GridLayout {
    ...
    public RadioGroup(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(
                attrs, R.styleable.RadioGroup, android.R.attr.radioButtonStyle, 0);
    ...
    protected GridLayout.LayoutParams generateDefaultLayoutParams() {
        return new LayoutParams(new MarginLayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
    }
     ...
     *
     * <p>See
     * {@link com.android.internal.R.styleable#GridLayout_Layout GridLayout Attributes}
